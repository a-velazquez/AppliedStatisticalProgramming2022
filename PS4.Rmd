...
freqT <- findMostFreqTerms(DTM, INDEX = 1:DTM$nrow)

ULfreqT <- unlist(freqT)[unlist(freqT) > 0.8]


# See how output is mostly URL remnants, some hashtags too
sort(ULfreqT, decreasing = TRUE)[1:50]

# as.matrix(removeSparseTerms(DTM, 0.95))
```
