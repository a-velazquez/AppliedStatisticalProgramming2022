...
# is.list(bad_door)
# is.integer(bad_door$selected)
# any(bad_door$selected %in% c(1,2,3))
...
PlayGame <- function(door){
  ...
  # Use the validator here to ensure input is of appropriate class
  door <- is_numbered(door)
