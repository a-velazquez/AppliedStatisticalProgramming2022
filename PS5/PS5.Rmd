...
```{r}
source("Trapezoid-class.R")
source("Simpson-class.R")
source("integrateIt.R")

text_x <- seq(from = 1, to = 3, by = 0.001)
testIntegral_S <- integrateIt(function(x){x^2}, 5, c(1, 3),"Simpson")
testIntegral_T <- integrateIt(function(x){x^2}, 10, c(1, 3),"Trapezoid")

print(testIntegral_S)
print(testIntegral_T)
...
```{r}
source("tolTest.R")
tolTest(function(x){x^2}, 5, tol=0.001, c(1,3), "Trapezoid")
```
